...
# My Facebook ( https://www.facebook.com/MD.HOSSAIN.XD )
...
class __crack__:
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            print '\n [%s+%s] hossain OK disimpan ke -> results/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)

                            print ' [%s+%s] hossain CP disimpan ke -> results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            ...
                            with YayanGanteng(max_workers=30) as (__yayanXD__):
                                ...
                                for ikeh in self.id:
                                    ...
                                    try:
                                        ...
                                        __hossainXD__.submit(self.__api__, kimochi, ysc)
                            ...
                            with YayanGanteng(max_workers=30) as (__HOSSAINXD__):
                                ...
                                for ikeh in self.id:
                                    ...
                                    try:
                                        ...
                                        __hossain__.submit(self.__mbasic__, kimochi, ysc)
                            ...
                            with YayanGanteng(max_workers=30) as (__MdHossain__):
                                ...
                                for ikeh in self.id:
                                    ...
                                    try:
                                        ...
                                        __hossainXD__.submit(self.__mfb,__, kimochi, ysc)
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            with hossainGanteng(max_workers=30) as (__yayanXD__):
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        __hossainXD__.submit(self.__api__, uid, pwx)
            ...
            with hossainGanteng(max_workers=30) as (__hossainXD__):
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        __hossainX__.submit(self.__mbasic__, uid, pwx)
            ...
            with YayanGanteng(max_workers=30) as (__hossainXD__):
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        __hossainXD__.submit(self.__mfb__, uid, pwx)
